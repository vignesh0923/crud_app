...
//            <span> <svg style={{width:"100%"}} xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 65 65" fill="none">
...
// <button id="cancelbtn" className="cancelbtn">Cancel</button>
// <button id="deletebtn" className="yesbtn">Yes</button>
//             </div>
//             </div> */}
